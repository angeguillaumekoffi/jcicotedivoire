...
class SignUpView(
    ...
    success_url = reverse_lazy("profiles:formulaire")
    form_valid_message = "Vous avez passé la première étape. Veillez completer le formulaire d'adhésion!"
...
class PasswordChangeView(authviews.PasswordChangeView):
    ...
    def form_valid(self, form):
        ...
        messages.success(
            self.request,
            "votre mot da passe a été changé, "
            "Veillez vous reconnecter s'il vous plait!",
        )
